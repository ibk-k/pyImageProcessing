...
BEGIN_DCIMG_DECLARE( enum, DCIMG_ERR )
{
  ...
  /* camera or bus trouble */
	...
	DCIMG_ERR_IMAGE_NEWRUNTIMEREQUIRED	= 0x84003002,/* version of image header is newer than version that used DCAM supports	*/
	...
	DCIMG_ERR_IMAGE_BROKENCONTENT		= 0x84004005,/*	image content is corrupted	*/
  ...
  /* internal error */
	...
	DCIMG_ERR_NEWERERFILEVERSION	= DCIMG_ERR_NEWERFILEVERSION
}
...
END_DCIMG_DECLARE( DCIMG_CODEPAGE )
...
END_DCIMG_DECLARE( DCIMG_FRAME_OPTION )
...
END_DCIMG_DECLARE( DCIMGDATA_OPTION )
...
END_DCIMG_DECLARE( DCIMGDATA_REGIONTYPE )
...
END_DCIMG_DECLARE( DCIMG_METADATAOPTION )
...
END_DCIMG_DECLARE( DCIMG_CAPABILITY_IMAGEPROC )
